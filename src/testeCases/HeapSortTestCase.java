...
public class HeapSortTestCase {
    ...
    public static void piorCaso() {
        ...
        for (int tamanhoVetor = 1; tamanhoVetor <= 1000; tamanhoVetor++) {
            ...
            heapsort(vetor);
            System.out.println("HeapSort_PiorCaso_Tamanho_" + tamanhoVetor + "_MédiaDeOperações_" + count);
        }
    }
    ...
    public static void casoMedio() {
        ...
        for (int tamanhoVetor = 1; tamanhoVetor <= 1000; tamanhoVetor++) {
            ...
            System.out.println("HeapSort_CasoMedio_Tamanho_" + tamanhoVetor + "_MédiaDeOperações_" + media);
        }
    }
